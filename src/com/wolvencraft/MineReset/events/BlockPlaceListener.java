...
public class BlockPlaceListener implements Listener
{
	...
	public void onBlockPlace(BlockPlaceEvent event)
	{
		...
		for(int i = 0; i < regionList.size(); i++)
		{
			if(usePermissions)
			{
				if(!Util.playerHasPermission(player, "protection") && !Util.playerHasPermission(player, "protection.place") && !Util.playerHasPermission(player, "protection.break." + regionList.get(i)))
				{
